  ...
  try {
    ...
    fs.createReadStream("./src/server/csv_files/house_members.csv")
      ...
      .on("data", (row) => {
        ...
        const { short_title, title, first_name, last_name, twitter_account, facebook_account, url, contact_form, next_election, total_votes, last_updated, office, phone, state } = row;
