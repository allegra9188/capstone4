    ...
    <main id="myAccount-main">
      <h2 className="details-name">
        ...
        {showInputs ? (
          <>
          <br />
            <input className="myAccount-inputs"
              id="firstName-Update"
              type="text"
          ...
          <p className="myAcct-info-text">{user.firstName} {user.lastName}</p>
        )}
      </h2>
      <br />
      <div>
      ...
      {/* <br /> */}
        <br />
      <button className="myAccount-btns" id="update-btn" onClick={() => setShowInputs(!showInputs)}>
        {showInputs ? 'Hide' : 'Update'}
      </button>
      {showInputs && (
        <button className="myAccount-btns" id="save-btn" onClick={handleUpdate}>
          Save
        </button>
      )}
  
      <button className="myAccount-btns" id="acct-logout" onClick={handleLogout}>
        Logout
      </button>
    </main>
    </html>
